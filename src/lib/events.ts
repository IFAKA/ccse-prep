...
export const blankState=():AppState=>({schemaVersion:CURRENT_SCHEMA_VERSION,questionStates:{},mockHistory:[],sessions:[],settings:{sound:false,dailyTarget:25},memories:[],events:[]});
