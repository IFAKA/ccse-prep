...
export const blankState=():AppState=>({schemaVersion:1,questionStates:{},mockHistory:[],sessions:[],settings:{sound:false,dailyTarget:25},memories:[],events:[]});
...
export function reduceEvents(events:readonly AppEvent[]) { return events.reduce(reduceEvent,blankState()); }
